    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scannerLiveView.setScannerViewEventListener(new ScannerLiveView.ScannerViewEventListener() {
            ...
            public void onScannerStarted(ScannerLiveView scanner) {
                Toast.makeText(ScanQRCodeActivity.this, "Сканер запущен", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerStopped(ScannerLiveView scanner) {
                Toast.makeText(ScanQRCodeActivity.this, "Сканер остановлен", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerError(Throwable err) {
                Toast.makeText(ScanQRCodeActivity.this, "Произошла ошибка сканера. Пожалуйста, начните заново...", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(grantResults.length > 0){
            ...
            if(cameraAccepted && vibrationAccepted){
                ...
                Toast.makeText(this, "В доступе отказано \n Вы не можете использовать приложение без разрешений", Toast.LENGTH_SHORT).show();
            }
        }
    }
}